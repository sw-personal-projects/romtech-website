    ...
    return (
        <FlipBottomToTop delay={0.2}>
            <footer className="py-16 px-6 sm:px-12 border-t border-white/15 md:mt-[200px] mt-[70px] bg-black">
                <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
                    ...
                    <div className="md:col-span-2 space-y-6">
                        <div className="flex items-center relative">
                            ...
                            />
                            <span className="text-5xl md:text-6xl font-bold font-[Poppins] text-transparent bg-clip-text bg-gradient-to-r from-white to-green-950 pl-14">
                                OM Tech
                            </span>
                        </div>
                        <p className="text-white/80 leading-relaxed max-w-lg md:pl-4">
                ...
                <div className="mt-16 border-t border-white/25 pt-6 text-center text-white/50 text-xs">
